...
%code{
   ...
   std::set<std::string> pred_procedures({"printf","scanf"});
   ...
   std::pair<exp_astnode*,std::string> funcall(std::string id,std::vector<exp_astnode*> params = std::vector<exp_astnode*>(0))
   {
      ...
      if(pred_procedures.count(id))
      {
         ...
         id_node = new identifier_astnode(id,dtype);
      }
      else
      {       
         ...
         id_node = new identifier_astnode(id,res_dtype);
      }
      exp_astnode *res;
      if(p_sz == 0)
...
%%
     ...
     postfix_expression: primary_expression { $$ = $1; }
                         ...
                         | postfix_expression '.' IDENTIFIER
                         {
                            ...
                            exp_astnode* id_node = new identifier_astnode(id,res_dtype);
     ...
     primary_expression: IDENTIFIER 
                        {
                           ...
                           $$ = new identifier_astnode(id,res_dtype);
                        }
                         | INT_CONSTANT
                         {
